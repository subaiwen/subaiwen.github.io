...
colnames(q) <- c("income", "standard error")
```
<p align="center">
  <img src="https://tva1.sinaimg.cn/large/006y8mN6ly1g6offwnl7bj30ek09ejsr.jpg" width="230">
</p>
...
colnames(bq) <- c("income", "standard error")
```
<p align="center">
  <img src="https://tva1.sinaimg.cn/large/006y8mN6ly1g6oextiwzbj30es09eta4.jpg" width="230">
</p>
...
#### Percentage over total expenditure
```r
pc <- am %>% slice( seq(1,nrow(am)-1,2) ) %>% slice(-nrow(.)) %>% column_to_rownames("Income group")
for (j in 1:nrow(pc)){
...
```
<p align="center">
  <img src="https://tva1.sinaimg.cn/large/006y8mN6ly1g6of7nvqv9j31j60eaqaf.jpg" width="600">
</p>
Notice that the higher income level people are in, the higher percentage their tax shares over their total expenditure. For example, for the top 0.1% (99.9-100 percentile) they have in average 54.5% paid in taxes. However, their income tax is only 29.3 percent over their income.
